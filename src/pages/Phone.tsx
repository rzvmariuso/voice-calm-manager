              ...
              <Card className="shadow-soft">
                ...
                <CardContent>
                  <div className="space-y-4">
                    ...
                    <div className="flex items-center justify-between">
                      <span className="text-sm text-muted-foreground">ElevenLabs Voice</span>
                      <div className="flex items-center gap-2">
                        <div className="w-2 h-2 bg-success rounded-full animate-pulse"></div>
                ...
                <CardContent>
                  <div className="space-y-3">
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-xs text-muted-foreground">
                          Deutsche Server, vollständige Compliance
                        </p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-start gap-3">
                      <Badge variant="outline" className="mt-1">🎯</Badge>
                      <div>
                        <p className="font-medium text-sm">Deutschland-optimiert</p>
                        <p className="text-xs text-muted-foreground">
                          Deutsche Telefonnummern & Akzente
                        </p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-start gap-3">
                      <Badge variant="outline" className="mt-1">🤖</Badge>
                      <div>
                        <p className="font-medium text-sm">KI-gestützt</p>
                        <p className="text-xs text-muted-foreground">
                          OpenAI GPT für intelligente Gespräche
                        </p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-xs text-muted-foreground">
                          Nahtlose Weiterleitung an Mitarbeiter
                        </p>
                      </div>
                    </div>
                  </div>
              ...
              <Card className="shadow-soft">
                ...
                <CardContent>
                  <div className="space-y-2">
                    ...
                    <div className="flex items-center gap-2 text-sm">
                      <Badge variant="outline">✓</Badge>
                      <span>Termine verschieben/löschen</span>
                    </div>
                    <div className="flex items-center gap-2 text-sm">
                      <Badge variant="outline">✓</Badge>
                      <span>An Mitarbeiter weiterleiten</span>
                    </div>
                    <div className="flex items-center gap-2 text-sm">
                      <Badge variant="outline">✓</Badge>
                      <span>Anrufaufzeichnung</span>
                    </div>
                    <div className="flex items-center gap-2 text-sm">
                      <Badge variant="outline">✓</Badge>
                      <span>Mehrsprachig (Deutsch fokus)</span>
                    </div>
                  </div>
                </CardContent>
              </Card>
